...
* [ParticleZoo](https://github.com/dobrienphd/ParticleZoo) - ![Static Badge](https://img.shields.io/badge/C%2B%2B-stuff?style=flat&logo=c%2B%2B&color=green) ![Static Badge](https://img.shields.io/badge/Python-stuff?style=flat&logo=python&color=lime) High-performance C++20 library for reading, writing, and manipulating particle phase space files across Monte Carlo simulation ecosystems (EGS, IAEA, TOPAS, penEasy, ROOT), with Python bindings. Provides a unified API with automatic format detection, parallel processing, and an extensible format registry.
